										...
										<div class="box-content">
											<form class="form-horizontal" method="POST" action="fungsi/edit/edit.php?profil=edit" enctype="multipart/form-data">
												<fieldset>
													...
													<div class="control-group">
														<label class="control-label" for="typeahead">Id Card </label>
														<div class="input-group">
														  <div class="input-group-addon">
															<i class="fa fa-user"></i>
														  </div>
															<input type="text" class="form-control" style="border-radius:0px;" name="card_id" value="<?php echo $hasil['card_id']; ?>" required="required"/>
														</div>
													</div>
													<div class="control-group">
